...
int main() {
	...
	list<string> specStrings = FileReaderUtils::readFile("CEPSpec.txt");
	list<CEPSpec*> cepSpecs = CEPSpecParser::parseAllCEPSpec(specStrings);
	
	CEPProcess cep = *(cepSpecs.front()->instance());
