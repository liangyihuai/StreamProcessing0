...
int main() {
	...
	//setup event filter spec
	list<string> specStr = FileReaderUtils::readFile("EventFilterSpec.txt");
	list<EventFilterSpec*> specList = EventFilterParser::parseAllEventFilterSpec(specStr);
	EventProcess * ep = specList.front()->instance();
